...
void setup(void){
 ...
 server.on("/01/y", [](){
  server.send(200, "text/plain", "Okay -- Light is ON!");
  toduino.println("ON01");
  });
   server.on("/02/y", [](){
  server.send(200, "text/plain", "Okay -- Light is ON!");
  toduino.println("ON02");
  });
  server.on("/03/y", [](){
  server.send(200, "text/plain", "Okay -- Light is OFF!");
  toduino.println("ON03");
  });
  server.on("/04/y", [](){
  server.send(200, "text/plain", "Okay -- Light is OFF!");
  toduino.println("ON04");
  });
   server.on("/05/y", [](){
  server.send(200, "text/plain", "Okay -- Light is ON!");
  toduino.println("ON05");
  });
  server.on("/06/y", [](){
  server.send(200, "text/plain", "Okay -- Light is OFF!");
  toduino.println("ON06");
  });
   
  server.on("/07/y", [](){
  server.send(200, "text/plain", "Okay -- Light is ON!");
  toduino.println("ON07");
  });
  server.on("/08/y", [](){
  server.send(200, "text/plain", "Okay -- Light is OFF!");
  toduino.println("ON08");
  });
  server.on("/09/y", [](){
  server.send(200, "text/plain", "Okay -- Light is OFF!");
  toduino.println("ON09");
  });
